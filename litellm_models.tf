...
resource "litellm_model" "model" {
  ...
  aws_access_key_id              = each.value.authentication == "aws" ? aws_iam_access_key.litellm_access_key.id : null
  aws_secret_access_key          = each.value.authentication == "aws" ? aws_iam_access_key.litellm_access_key.secret : null
